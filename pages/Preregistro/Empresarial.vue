...
<div>
    <v-card>
        <v-card-title>
            <v-toolbar-title class="display-1">Preregistros Empresariales</v-toolbar-title>
                                    ...
                                    <v-container>
                                        <v-form ref="preregistroForm" id="preregistroForm" name="preregistroForm">
                                            <v-row>
                                                ...
                                                <input type="hidden" name="tipo_registro" :value="2" v-else>
                                                <v-col cols="12" md="6">
...
export default {
    transition: "slide",
    head: {
        title: "Preregistros - Empresarial"
    },
    data() {
        return {
            search: '',
